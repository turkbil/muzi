<?php
    $playlist = $content->moduledata->mod;    
?>
 <!-- Banner Area Start -->
        <Section class="artist-banner">
        <img src="<?php echo THEMEURL; ?>/assets/media/bg/artist-bg-2.jpg" alt="" class="bg-img">
        <div class="content">
            <img src="<?php echo SITEURL;?>/thumbmaker.php?src=<?php echo SITEURL;?>/modules/muzibu/dataimages/<?php echo $playlist->thumb != "" ? $playlist->thumb : $playlist->album_thumb ;?>&amp;h=410&amp;w=410&amp;s=1&amp;a=c&amp;q=80" alt="" class="artist-img">
            <div>
                <span class="d-flex align-items-center"><?php echo $playlist->song_count;?> Şarkı</span>
                <h1><?php echo $playlist->title_tr;?></h1>
        ...
        <!-- Banner Area End -->
         ...
         <!-- Popular Music Start -->
        <section class="py-24">
            <h4 class="mb-24">Şarkılar</h4>
            <div class="songs-list">
                
                <?php 
                    $songs = Registry::get('Muzibu')->getPlaylistSongs($playlist->id);
                    if($user->logged_in):
        ...
        <script type="text/template" id="song-template">
            <div class="song-card">
                    <div class="left-block">
                        <div class="play">
                            <a href="javascript:;" class="play track-list" data-track="{{track_path}}" data-poster="{{poster}}" data-title="{{title}}" data-singer="{{singer}}" data-id="{{song_id}}"><i class="fas fa-play"></i></a>
                            <span><?php echo str_pad($i,2,"0",STR_PAD_LEFT);?></span>
                        </div>
                        <img src="<?php echo SITEURL;?>/thumbmaker.php?src=<?php echo SITEURL;?>/modules/muzibu/dataimages/<?php echo $song->thumb;?>&amp;h=410&amp;w=410&amp;s=1&amp;a=c&amp;q=80" alt="">
                        <div>
                    ...
                    <span class="duration">3:21 sec</span>
                    <div class="right-block">
                        <a href="javascript:;" class="add-to-favorite" data-id="<?php echo $song->id;?>" data-status="<?php echo in_array($song->id,$favorites) ? "true" : "false";?>"><span class="tooltip-pop">Add to Favorites</span><i class="fa-regular fa-heart"></i></a>
                        <a href="javascript:;" class="add-to-playlist" data-id="<?php echo $song->id;?>">
                            <span class="tooltip-pop">Listeye Ekle</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                <path d="M0.5 4.58991C0.5 4.02195 0.960426 3.56152 1.52839 3.56152H15.9178C16.4857 3.56152 16.9462 4.02195 16.9462 4.58991C16.9462 5.15788 16.4857 5.6183 15.9178 5.6183H1.52839C0.960426 5.6183 0.5 5.15788 0.5 4.58991Z"/>
                                <path d="M0.5 10.2761C0.5 9.70817 0.960426 9.24775 1.52839 9.24775H15.9178C16.4857 9.24775 16.9462 9.70817 16.9462 10.2761C16.9462 10.8441 16.4857 11.3045 15.9178 11.3045H1.52839C0.960426 11.3045 0.5 10.8441 0.5 10.2761Z"/>
                                <path d="M0.5 15.9626C0.5 15.3947 0.960426 14.9342 1.52839 14.9342H12.1221C12.6901 14.9342 13.1505 15.3947 13.1505 15.9626C13.1505 16.5306 12.6901 16.991 12.1221 16.991H1.52839C0.960426 16.991 0.5 16.5306 0.5 15.9626Z"/>
