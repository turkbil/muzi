<?php
   ...
   * @copyright 2014
   * @version $Id: layout_search.tpl.php, v4.00 2014-03-23 16:18:34 Nurullah Okatan
   */
...
<?php Filter::msgAlert(Lang::$word->_SR_SEARCH_EMPTY . '<span class="tubi black label">'.$keyword.'</span>' . Lang::$word->_SR_SEARCH_EMPTY1);?>
<?php else:?>
<h1 class="tubi double header"><span><?php echo '<small class="tubi label">' . count($latestrow) . '</small> ' .Lang::$word->_SR_SEARCH2 . $keyword;?></span></h1>
