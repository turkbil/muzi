...
<article id="article" class="clearfix">
  <figure class="small-top-space small-bottom-space">
    ...
    <?php else:?>
    <?php if($row->thumb):?>
    <div class="image-overlay tubi right floated image"> <img src="<?php echo SITEURL;?>/thumbmaker.php?src=<?php echo SITEURL.'/'.Blog::imagepath . $row->thumb;?>&amp;h=200&amp;w=300&amp;s=1&amp;a=tl" alt="">
