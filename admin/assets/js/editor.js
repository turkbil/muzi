    ...
    $.Redactor.opts = {
        ...
        langs: {
            en: {
                ...
                link_edit: 'Linki Düzenle',
                unlink: 'Linki Kaldır',
                ilink: 'Dışarıdan Link',
                ilink_select: 'İçeriden Link Seçiniz',
                link_insert: 'Link Ekle',
                formatting: 'Format',
                ...
                bold: 'Kalın',
                italic: 'Eğik',
                fontcolor: 'Yazi Rengi',
                backcolor: 'Arkaplan Rengi',
                unorderedlist: 'Sirasiz Liste',
                orderedlist: 'Sirali Liste',
                outdent: 'Outdent',
                indent: 'Indent',
                cancel: 'Çıkış',
                insert: 'Ekle',
                ...
                right: 'Sağ',
                center: 'Orta',
                image_web_link: 'Webden Görsel Al',
                text: 'Yazı',
                mailto: 'Email',
                web: 'Link',
                ...
                choose: 'Seçiniz',
                or_choose: 'ya da sec',
                drop_file_here: 'Dosyaları buraya surukleyin',
                align_left: 'Yazıyı Sola Yasla',
                align_center: 'Yazıyı Ortala',
                align_right: 'Yazıyı Sağa Yasla',
                align_justify: 'Yazıyı Sağa Sola Eşitle',
                horizontalrule: 'Düz Çizgi Ekle',
                deleted: 'Üstü Çizili',
                anchor: 'Anchor',
                link_new_tab: 'Linki Yeni Pencerede Aç',
                img_new_tab: 'Resmi Lightboxda Aç',
                underline: 'Altı Çizili',
                alignment: 'Sıralama',
                filename: 'İsim (opsiyonel)',
                edit: 'Düzenle',
                manager: 'Dosya Yönetimi',
                browse: 'Gözat...',
                browseFiles: 'Dosya Seçin',
    ...
    Redactor.fn = $.Redactor.prototype = {
        ...
        tableInsert: function() {
            ...
            var rows = $('#redactor_table_rows').val(),
                ...
                $table = $('<table id="table' + tableId + '" class="tubi table"><tbody></tbody></table>'),
                i, $row, z, $column;
		...
		modalTemplatesInit: function()
		{
			$.extend( this.opts,
			{
				...
				+ '<section id="redactor-modal-image-edit" class="tubi form">'
				...
				+ '<section class="footer">'
					+ '<div class="tubi three fluid buttons">'
					+ '<button class="redactor_btn_modal_close tubi negative button" id="redactor_image_delete_btn">' + this.opts.curLang.remove + '</button>'
					+ '<button class="redactor_btn_modal_close tubi warning button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn tubi positive button" id="redactorSaveBtn">' + this.opts.curLang.save + '</button>'
					+ '</div>'
				+ '</section>',
				...
				+ '<section class="footer">'
					...
					+ '<button class="redactor_btn_modal_close tubi negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn tubi positive button" id="redactor_upload_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',

				modal_link: String()
				+ '<section id="redactor-modal-link-insert" class="tubi form">'
				...
				+ '<section class="footer">'
					+ '<div class="tubi two fluid buttons">'
					+ '<button class="redactor_btn_modal_close tubi negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn tubi positive button" id="redactor_insert_link_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',

				modal_table: String()
				+ '<section id="redactor-modal-table-insert" class="tubi form">'
				...
				+ '<section class="footer">'
					+ '<div class="tubi two fluid buttons">'
					+ '<button class="redactor_btn_modal_close tubi negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn tubi positive button" id="redactor_insert_table_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',

				modal_video: String()
				+ '<section id="redactor-modal-video-insert">'
					+ '<form id="redactorInsertVideoForm" class="tubi form">'
				...
				+ '<section class="footer">'
					+ '<div class="tubi two fluid buttons">'
					+ '<button class="redactor_btn_modal_close tubi negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn tubi positive button" id="redactor_insert_video_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',
			   ...
			   + '<div id="redactor_tabs">' 
				...
				+ '</div>' 
				+ '<div id="redactor_tab1" class="redactor_tab tubi segment full fit form">' 
				+ '<div data-modal-select="true" class="tubi fluid selection dropdown">' 
				+ '<input name="directory" type="hidden" value="">' 
				+ '<div class="text">Dizin Seçin</div>' 
				+ ' <i class="dropdown icon"></i>' 
				+ '<div class="menu">' 
				+ '<div class="item" data-value=""><i class="icon home"></i> Ana Dizin</div>' 
				+ '</div>' 
				+ '</div>' 
				...
				+ '</div>' 
				+ '</div>' 
				+ ' <div id="redactor_tab2" class="redactor_tab tubi segment full fit form" style="display: none;">' 
				+ '<div id="uploader">' 
        ...
        getFiles: function() {
            $.ajax({
                ...
                beforeSend: function() {
                    $("#cms_files .tubi.form").addClass('loading');
                },
                success: function(json) {
                    if (json.type == "success") {
                        setTimeout(function() {
                            $("#cms_files .tubi.form").removeClass('loading');
                        }, 250);
