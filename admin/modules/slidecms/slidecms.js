(function ($, doc, win) {
    ...
    TubiGrid.prototype.init = function () {
    ...
    TubiGrid.prototype.getColumnsCount = function () {
    ...
    TubiGrid.prototype.onNewContentLoaded = function () {
        this.$el.elasticColumns('refresh');
        this.displayItems();
    };

    TubiGrid.prototype.displayItems = function () {
        var delay = 0;
    ...
    $.fn.TubiGrid = function (opts) {
        return this.each(function () {
            new TubiGrid(this, opts);
        });
    };
    TubiGrid.prototype.onDeleteImage = function () {
        $('body').on('click', '#slidedata a.tubi.label', $.proxy(function (e) {
    ...
    TubiGrid.prototype.fileUpload = function () {
        var ul = $('#upload ul');
