<?php
   ...
   * @copyright 2010
   * @version $Id: class_security.php, v2.00 2011-04-20 18:20:24 Nurullah Okatan
   */
  ...
  class IpnListener
  {
      ...
      protected function curlPost($encoded_data)
      {
		  ...
		  curl_setopt($ch, CURLOPT_HTTPHEADER, array('Connection: Close', 'User-Agent: turkbilisim.com.tr'));
