<?php
   ...
   * @copyright 2014
   * @version $Id: class_paginate.php, v1.00 2012-03-05 10:12:05 Nurullah Okatan
   */
  ...
  class Paginator
  {
      ...
      {
          return($this->items_total > $this->items_per_page) ? '<div class="tubi pagination menu">' . $this->retdata . '</div>' : "";
      }
  }
?>