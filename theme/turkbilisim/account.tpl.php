...
$muzibu = new Muzibu();
  ...
  $favoriteMusic = $muzibu->getUserFavoriteSongs($user->uid);
 ...
 <!-- Banner Area Start -->
         <Section class="profile-banner">
            ...
            <div class="content">
                ...
                <div class="btn-block">
                    <a href="" class="cus2-btn">Ana Sayfa</a>
                    <a href="" class="cus2-btn sec">Beğendikleriniz</a>
                    <a href="" class="cus2-btn sec">Oynatma Listeleri</a>
                </div>
            </div>
         </Section>
        <!-- Banner Area End -->

        <section class="pb-40 mt-4">
    <h4>Beğendikleriniz</h4>
    <div class="row mt-3">
        <div class="songs-list">
                <?php if($songs):?>
                <?php 
                    $favorites = $muzibu->getUserFavoritesBySongs($user->uid,$favoriteMusic);
                ?>
                <?php 
                $i=0;
                foreach($favoriteMusic as $song):
                $i++;
                ...
                <div class="song-card">
                     <div class="left-block">
                        <div class="play">
                            <a href="javascript:;" class="play track-list" data-track="<?php echo $trackPath; ?>" 
...
<!-- Trending Music End -->
 ...
 <section class="pb-40">
    <h4>Oynatma Listeleri</h4>
    <div class="row mt-3">
        <?php if ($playlists): 
            foreach ($playlists as $playlist): 
            $thumbPath = $playlist->thumb ? SITEURL . '/thumbmaker.php?src=' . SITEURL . '/modules/muzibu/dataimages/' . $playlist->thumb . '&amp;h=300&amp;w=400&amp;s=1&amp;a=c&amp;q=80' : THEMEURL . '/assets/media/songs/trending-01.jpg';
        ?>
        <!-- slide item  -->
        <div class="col-12 col-md-3 my-2">
            <a href="playlist-single.html" class="music-card">
                <img src="<?php echo $thumbPath; ?>" alt="<?php echo $playlist->title_tr; ?>">
                <div class="content">
